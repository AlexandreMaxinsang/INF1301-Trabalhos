   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar inserir elemento antes */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_ANTES_CMD ) == 0 )
         {
            ...
            CondRetEsp = LIS_InserirElementoAntes( vtListas[ inxLista ] , pDado ) ;
      ...
      /* Testar inserir elemento apos */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_APOS_CMD ) == 0 )
         {
            ...
            CondRetEsp = LIS_InserirElementoApos( vtListas[ inxLista ] , pDado ) ;
      ...
      /* Testar obter valor do elemento corrente */
         ...
         {
			 char valor;
            numLidos = LER_LerParametros( "ici" , &inxLista , &pDado , &ValEsp ) ;
            ...
            if ( pDado == ' ' )
            {
               return TST_CompararInt( 1 , ValEsp , "Dado tipo um deveria existir." ) ;
            } /* if */

            return TST_CompararChar( pDado , valor , "Valor do elemento errado." ) ;
