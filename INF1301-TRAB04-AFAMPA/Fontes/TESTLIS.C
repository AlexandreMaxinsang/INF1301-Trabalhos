   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar inserir elemento antes */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_ANTES_CMD ) == 0 )
         {
            ...
            #ifdef _DEBUG
            CondRet = LIS_InserirElementoAntes( vtListas[ inxLista ] , pDado , sizeof(strlen( StringDado ) + 1) );
#else
...
#ifdef _DEBUG
            CondRet = LIS_InserirElementoApos( vtListas[ inxLista ] , pDado , sizeof(strlen( StringDado ) + 1) );
#else
...
/* Testar verificador de cabeça */
         ...
         else if ( strcmp( ComandoTeste , VER_CABECA_CMD ) == 0 )
         {
            ...
            return (TST_tpCondRet)LIS_VerificarCabeca( vtListas[ inxLista ] );
...
/* Testar verificador de Lista */
         ...
         else if ( strcmp( ComandoTeste , VER_LISTA_CMD ) == 0 )
         {
            ...
            return TST_CompararInt( CondRetEsp , LIS_VerificarLista( vtListas[ inxLista ] ) , "Retorno incorreto ao verificar lista." ) ;
...
/* Deturpar uma lista */
         ...
         else if ( strcmp( ComandoTeste , DETURPAR_CMD ) == 0 )
         {
            ...
            numLidos = LER_LerParametros( "ii" , &inxLista , &DeturpaEsperado ) ;
            ...
            LIS_Deturpar( vtListas[ inxLista ] , (LIS_tpModosDeturpacao)DeturpaEsperado ) ;
